...
// Optimized CSS with full-width fixes
const optimizedCSS = `
<style>
/* ============================================
   BEACHHYDROVAC - OPTIMIZED FULL-WIDTH CSS
   ============================================ */
...
/* FULL WIDTH FIXES - Force blocks to be full width */
body.page-id-10,
...
/* Hide header/footer if using canvas template */
...
<div class="wp-block-button btn-secondary"><a class="wp-block-button__link wp-element-button">Our Services</a></div>
<!-- /wp:button -->

<!-- wp:button {"className":"btn-primary"} -->
<div class="wp-block-button btn-primary"><a class="wp-block-button__link wp-element-button">Get A Quote</a></div>
<!-- /wp:button -->
...
<i class="fas fa-map-marker-alt" style="font-size:52px;color:#1a365d;"></i>
</div>
<!-- /wp:html -->
...
<!-- wp:html -->
<div style="text-align:center;margin-bottom:20px;">
<i class="fas fa-handshake" style="font-size:52px;color:#f7bb14;"></i>
</div>
<!-- /wp:html -->
...
<!-- wp:html -->
<div style="text-align:center;margin-bottom:20px;">
<i class="fas fa-shield-alt" style="font-size:52px;color:#f7bb14;"></i>
</div>
<!-- /wp:html -->
...
<!-- wp:button {"className":"btn-primary"} -->
<div class="wp-block-button btn-primary"><a class="wp-block-button__link wp-element-button">View All Services</a></div>
<!-- /wp:button -->
...
<!-- wp:html -->
<div class="veteran-badge" style="margin-bottom:20px;">
...
<!-- wp:html -->
<ul style="list-style:none;padding:0;margin:0;color:white;font-size:18px;line-height:2.4;">
...
<!-- wp:button {"backgroundColor":"white","style":{"border":{"radius":"9999px"},"typography":{"fontSize":"18px","fontStyle":"normal","fontWeight":"700"},"elements":{"link":{"color":{"text":"#1a365d"}}}},"textColor":"black"} -->
<div class="wp-block-button" style="font-size:18px;font-style:normal;font-weight:700"><a class="wp-block-button__link has-black-color has-white-background-color has-text-color has-background has-link-color wp-element-button" href="tel:7577855177" style="border-radius:9999px">📞 Call 757-785-5177</a></div>
<!-- /wp:button -->
...
<div class="wp-block-button" style="font-size:18px;font-style:normal;font-weight:700"><a class="wp-block-button__link has-text-color has-background wp-element-button" style="border-radius:9999px;border-width:2px;color:#ffffff;background-color:#1a365d00">Request Quote</a></div>
<!-- /wp:button -->
...
<li style="margin-bottom:12px;"><a href="/" style="color:#cbd5e1;text-decoration:none;transition:color 0.2s;">Home</a></li>
<li style="margin-bottom:12px;"><a href="/services" style="color:#cbd5e1;text-decoration:none;transition:color 0.2s;">Services</a></li>
<li style="margin-bottom:12px;"><a href="/about" style="color:#cbd5e1;text-decoration:none;transition:color 0.2s;">About</a></li>
<li style="margin-bottom:12px;"><a href="/contact" style="color:#cbd5e1;text-decoration:none;transition:color 0.2s;">Contact</a></li>
</ul>
<!-- /wp:html -->
...
<p class="has-text-align-center has-text-color" style="color:#94a3b8">© 2026 BeachHydrovac. All rights reserved. A division of <a href="https://aimlocating.com" target="_blank" style="color:#f7bb14;">AIM Locating</a>.</p>
<!-- /wp:paragraph -->
...
async function updateHomepage() {
  console.log('Updating BeachHydrovac homepage with optimized full-width design...\n');
  ...
  try {
    ...
    console.log('✅ Homepage updated with full-width optimized design!');
